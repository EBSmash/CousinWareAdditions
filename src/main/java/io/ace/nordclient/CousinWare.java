...
{
    public static final String MODID = "27.club";
    public static final String NAME = "27.club";
    ...
    public void preInit(FMLPreInitializationEvent event) {
        Display.setTitle("27.club " + VERSION + " - " + UID.getUID());
    }
    ...
    public void loadHacks() {
        ...
        HackManager.addHack(new nocum());
        HackManager.addHack(new nocom());
        //misc
        HackManager.addHack(new AntiRegear());
        HackManager.addHack(new Coords2Discord());
        HackManager.addHack(new AutoWither());
//        HackManager.addHack(new AutoBreedAnimals());
...
//         HackManager.addHack(new zoom()) <----- 
       ...
       // HackManager.addHack(new AfkGhast());
        ...
        HackManager.addHack(new GhostFirework());
